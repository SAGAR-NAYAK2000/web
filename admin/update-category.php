    ...
    <div class="wrapper">
        ...
        <?php
          if(isset($_GET['id']))
          {
              ...
              {
                  //rediurect to manage category with session message
            ...
            if($image_name!="")
            {
              ...
              //A.upload the new image
               ...
               //auto rename our image
                //get the extension of our image(jpg,png,gif,etc) e.g."shoe1.jpg"
                $ext =end(explode('.',$image_name));

                //rename the image
                $image_name = "Shoe_Category_".rand(000, 999).'.'.$ext; //e.g. Shoe_category_834.jpg
